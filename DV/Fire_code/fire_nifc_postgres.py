...
import subprocess
import psycopg2
localpath = r'E:\Fire_process'
path=os.chdir(localpath)
#for file in os.scandir(path):
 #os.remove(file.path))
filetypes = ['shp']
dir = r'E:\Fire_process'
...
os.chdir(localpath)
cmd = 'shp2pgsql -s 0 "E:/Fire_process/'+files[0][0]+'" public.Perimeters | psql'
